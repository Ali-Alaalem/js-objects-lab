...
game.party.splice(2, 1, pokemon[3]);
...
*/
game.party.catchPokemon = function (pokemonObj) {
  game.party.push(pokemonObj);
  game.items[1].quantity -= 1;
};
game.party.catchPokemon(pokemon[2]);
game.party.catchPokemon(pokemon[26]);
game.party.catchPokemon(pokemon[9]);
...
*/
let gymTally = { complete: 0, uncomplete: 0 };
...
console.log("----------------------------------------------------");
console.log(`Answer of Exercise 16 here:`);
console.log(game);
